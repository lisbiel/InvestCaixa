...
# Fase 6: Testes de Integração - End-to-End Fluxo Completo

e2e_integration_tests = {
    "tests/InvestmentSimulation.UnitTests/IntegrationTests/EndToEndIntegrationTests.cs": '''namespace InvestmentSimulation.UnitTests.IntegrationTests;
...
for path, content in e2e_integration_tests.items():
    os.makedirs(os.path.dirname(path), exist_ok=True)
    with open(path, 'w', encoding='utf-8') as f:
        f.write(content)

print("✅ End-to-End Integration Tests criados com sucesso!")
